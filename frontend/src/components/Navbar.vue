...
<template>
  <nav id="navbar"
    ...
    <a href="https://www.conda.at/en/home-en/" class="flex lg:gap-4 gap-2 items-center cursor-pointer group"
      ...
      <img width="150"
        ...
        class="responsive mr-3" alt="CONDA Crowdinvesting - investieren in Startups und KMU" decoding="async"
    ...
    <div id="menu" class="flex lg:gap-8 md:gap-4 items-center text-black dark:text-white">
      <button id="theme-toggle-desktop"
        ...
        draggable="false" aria-label="theme-toggle">
        <svg
      ...
      <div class="group-fast">
        <a href="https://www.conda.at/en/about-crowdinvesting/" id="nav-desktop-features"
          class="relative underline-animation font-medium hover:text-[#63ab8e] transition duration-300" target="_blank"
          rel="noopener noreferrer" draggable="false">start investing</a>
      </div>
      <div class="group-fast">
        <a href="https://www.conda.at/en/unternehmen-finanzieren-en/" id="nav-desktop-faq"
          class="relative underline-animation font-medium hover:text-[#63ab8e] transition duration-300" target="_blank"
          rel="noopener noreferrer" draggable="false">raise funding</a>
      </div>
      <div class="group-fast">
        <a href="https://www.conda.at/en/?page_id=113223" id="nav-desktop-contact"
          class="relative underline-animation font-medium hover:text-[#63ab8e] transition duration-300" target="_blank"
          rel="noopener noreferrer" draggable="false">about us</a>
      </div>
      <div class="group-fast">
        <a href="https://www.conda.at/en/newsletter-subscription/" id="nav-desktop-contact"
          class="relative underline-animation font-medium hover:text-[#63ab8e] transition duration-300" target="_blank"
          rel="noopener noreferrer" draggable="false">newsletter</a>
      </div>
    </div>
  </nav>
</template>
